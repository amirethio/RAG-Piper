...
const Login = () => {
  ...
  return (
    <div className="w-120 mx-auto text-white">
      <div className="h-210 flex flex-col items-center">
        ...
        >
          ...
          <div className="text-gray-400 mt-5 hover:text-[#37cc37] cursor-pointer">
            <a>Forgot Password?</a>
          </div>
          ...
          <div className="flex items-center gap-1 mt-5">
            <span className="text-gray-400">New to PipedPiper?</span>
