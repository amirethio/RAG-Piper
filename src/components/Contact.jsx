      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-pretty leading-relaxed text-muted-foreground">
            Interested in joining the beta or partnering with PiedPiper? We
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="rounded-xl border border-border bg-card p-6">
              <p className="text-sm leading-relaxed text-muted-foreground">
                PiedPiper is currently in private beta. We are selectively
                onboarding enterprise partners and early adopters. Fill out the
              ...
              <div className="grid gap-5 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <input
                    ...
                    type="email"
                    required
                    placeholder="richard@iedpiper.io"
                    className="w-full rounded-lg border border-border bg-background px-4 py-2.5 text-sm text-foreground placeholder-muted-foreground outline-none transition-colors focus:border-primary"
                  />
                </div>
              </div>
